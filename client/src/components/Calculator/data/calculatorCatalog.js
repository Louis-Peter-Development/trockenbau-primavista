...
export const packages = [
  ...
  },
  {
    ...
    included: [
      ...
      'Montagezeit als Richtwert zu einem Stundensatz',
...
export const addOns = [
  ...
  {
    id: 'spachteln',
    title: 'Spachtelarbeiten (Basic Finish)',
    unitPrice: 14,
    unit: 'm²',
    pricingMode: 'area',
    materialRatio: 0.24,
  ...
  {
    id: 'dachschraegen-parador-deckenleiste',
  ...
  {
    id: 'dachschraegen-rigidur-dachbodenelement',
    title: 'Rigidur Dachbodenelement 032 TF 85 1500x500x85 mm',
    unitPrice: 42,
    unit: 'qm',
    pricingMode: 'flat',
    materialRatio: 0.84,
  ...
  {
    id: 'dachschraegen-rockwool-masterrock',
  ...
  {
    id: 'dachschraegen-innenausbau-varianten',
    title: 'Weitere Produkte Innenausbau',
    unitPrice: 0,
    unit: 'Stk.',
    pricingMode: 'flat',
...
export const calculatorChoices = [
  ...
  },
  {
    ...
    addOnIds: [
      ...
      'dachschraegen-daemmung-montage',
      'dachschraegen-rigidur-dachbodenelement',
      'dachschraegen-rockwool-masterrock',
      'dachschraegen-revisionsklappe',
      'dachschraegen-dachfenster-montage',
      'dachschraegen-velux-solarfenster',
      'dachschraegen-velux-rollo',
      'dachschraegen-parador-paneele',
      'dachschraegen-parador-deckenleiste',
      'dachschraegen-innenausbau-varianten',
    ],
  },
  {
    id: 'alles',
